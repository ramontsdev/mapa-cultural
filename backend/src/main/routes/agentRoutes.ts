...
import { makeListAgentsController } from '@/main/factories/controllers/agent/listAgentsControllerFactory';
...
agentRoutes.get('/agents', adaptExpressRoute(makeListAgentsController()));
