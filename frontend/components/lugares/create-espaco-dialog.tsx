...
export function CreateEspacoDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        showCloseButton
        className="flex max-h-dvh w-full max-w-[calc(100%-2rem)] flex-col gap-0 overflow-hidden rounded-none p-0 sm:max-h-[90vh] sm:max-w-lg sm:rounded-lg"
      >
                ...
                render={() => (
                  <FormItem>
                    ...
                    {areasDisponiveis.length > 0 ? (
                      ...
                      >
                        <SelectTrigger className="mt-2 w-full border-dashed">
                      ...
                      <p className="text-muted-foreground mt-1 text-xs">
                        Todas as áreas foram adicionadas.
                      </p>
                    )}
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Descreva o espaço em poucas linhas"
